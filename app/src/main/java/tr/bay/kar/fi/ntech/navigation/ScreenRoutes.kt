...
sealed class ScreenRoutes(val route: String) {
    ...
    data object AdviceScreen : ScreenRoutes(ADVICE_SCREEN)
    ...
    data object UnwantedExpensesScreen : ScreenRoutes(UNWANTED_SCREEN)
    ...
    companion object {
        ...
        private const val ADVICE_SCREEN = "Advice_Screen"
        ...
        private const val UNWANTED_SCREEN = "Unwanted_Screen"
